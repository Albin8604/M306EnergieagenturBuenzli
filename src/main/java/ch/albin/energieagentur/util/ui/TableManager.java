package ch.albin.energieagentur.util.ui;

import ch.albin.energieagentur.util.Validator;
import ch.albin.energieagentur.util.ui.annotation.TableCol;
import ch.albin.energieagentur.util.ui.annotation.TableIgnore;
