package ch.albin.energieagentur.test.util.files;

import ch.albin.energieagentur.test.model.TestPerson;
import ch.albin.energieagentur.util.files.CSVFileManager;
import ch.albin.energieagentur.util.files.JSONFileManager;
