package ch.albin.energieagentur.test.model;

import ch.albin.energieagentur.util.adapter.deserializer.LocalDateTimeDeserializer;
import ch.albin.energieagentur.util.adapter.deserializer.LocalTimeDeserializer;
import ch.albin.energieagentur.util.adapter.serializer.LocalDateTimeSerializer;
import ch.albin.energieagentur.util.adapter.serializer.LocalTimeSerializer;
